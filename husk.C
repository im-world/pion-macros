...
void husk(int print = 1, int debug = 0, Double_t energyCutAggregate = 0.0, Double_t energyCut = 0.0)
{
  ...
  TH2D *te_by_ge_ge_EtaCut_CircularCut = new TH2D("te_by_ge_ge_EtaCut_CircularCut","te_{agg}/ge vs ge",200,0,30,200,-3,3);
  TH2D *te_by_ge_ge_EtaCut_CircularCut_HCALIN = new TH2D("te_by_ge_ge_EtaCut_CircularCut_HCALIN","te_{agg}/ge vs ge",200,0,30,200,-3,3);
  TH2D *te_by_ge_ge_EtaCut_CircularCut_HCALOUT = new TH2D("te_by_ge_ge_EtaCut_CircularCut_HCALOUT","te_{agg}/ge vs ge",200,0,30,200,-3,3);
  TH2D *te_by_ge_ge_EtaCut_CircularCut_CEMC = new TH2D("te_by_ge_ge_EtaCut_CircularCut_CEMC","te_{agg}/ge vs ge",200,0,30,200,-3,3);

  auto *mean_te_by_ge_ge_EtaCut_CircularCut = new TProfile("mean_te_by_ge_ge_EtaCut_CircularCut","Mean_{te/ge}",nSlicesx,0,30,-3,3);
  auto *mean_te_by_ge_ge_EtaCut_CircularCut_HCALIN = new TProfile("mean_te_by_ge_ge_EtaCut_CircularCut_HCALIN","Mean_{te/ge}",nSlicesx,0,30,-3,3);
  auto *mean_te_by_ge_ge_EtaCut_CircularCut_HCALOUT = new TProfile("mean_te_by_ge_ge_EtaCut_CircularCut_HCALOUT","Mean_{te/ge}",nSlicesx,0,30,-3,3);
  auto *mean_te_by_ge_ge_EtaCut_CircularCut_CEMC = new TProfile("mean_te_by_ge_ge_EtaCut_CircularCut_CEMC","Mean_{te/ge}",nSlicesx,0,30,-3,3);
