...
void LoopEvalHRSingle(int print = 1, int debug = 0, Double_t energyCutAggregate = 0.0, Double_t energyCut = 0.0)
{
  ...
  for(int i=0; i<T1->GetEntries(); i++) // We assume same no. of entries, since no cuts are applied
	...
	if(te_aggregate_CircularCut > energyCutAggregate){
	  ...
	  te_by_ge_ge_EtaCut->Fill(ge, (te_aggregate-ge)/ge);

	  if(debug==1){	
	    cout<<"(ge, (te_aggregate-ge)/ge): ("<<ge<<", "<<(te_aggregate-ge)/ge<<")\n";
	  }

	  te_by_ge_ge_EtaCut_CircularCut->Fill(ge, (te_aggregate_CircularCut-ge)/ge);
	  te_by_ge_ge_EtaCut_CircularCut_HCALIN->Fill(ge, (te_aggregate_HCALIN_CircularCut-ge)/ge);
	  te_by_ge_ge_EtaCut_CircularCut_HCALOUT->Fill(ge, (te_aggregate_HCALOUT_CircularCut-ge)/ge);
	  te_by_ge_ge_EtaCut_CircularCut_CEMC->Fill(ge, (te_aggregate_CircularCut-te_aggregate_HCALIN_CircularCut-te_aggregate_HCALOUT_CircularCut - ge)/ge);

	  mean_te_by_ge_ge_EtaCut_CircularCut_HCALIN->Fill(ge, (te_aggregate_HCALIN_CircularCut-ge)/ge);
	  mean_te_by_ge_ge_EtaCut_CircularCut_HCALOUT->Fill(ge, (te_aggregate_HCALOUT_CircularCut-ge)/ge);
	  mean_te_by_ge_ge_EtaCut_CircularCut_CEMC->Fill(ge, (te_aggregate_CircularCut-te_aggregate_HCALIN_CircularCut-te_aggregate_HCALOUT_CircularCut-ge)/ge);
     
     
	  if(debug==1){
	    cout<<"\n(ge, (te_aggregate_CircularCut-ge)/ge): ("<<ge<<", "<<(te_aggregate_CircularCut-ge)/ge<<")\n"; 
	    cout<<"(ge, (te_aggregate_HCALIN_CircularCut-ge)/ge): ("<<ge<<", "<<(te_aggregate_HCALIN_CircularCut-ge)/ge<<")\n"; 
	    cout<<"(ge, (te_aggregate_HCALOUT_CircularCut-ge)/ge): ("<<ge<<", "<<(te_aggregate_HCALOUT_CircularCut-ge)/ge<<")\n";
	    cout<<"(ge, (te_aggregate_CircularCut-te_aggregate_HCALIN_CircularCut - te_aggregate_HCALOUT_CircularCut - ge)/ge): ("<<ge<<", "<<(te_aggregate_CircularCut-te_aggregate_HCALIN_CircularCut - te_aggregate_HCALOUT_CircularCut - ge)/ge<<")\n\n"; 
	  }      
	}
      }  
    }
  ...
  Double_t weight_HCALIN = 1.0 + te_by_ge_ge_EtaCut_CircularCut_HCALIN->GetMean(2);
  ...
  for(int binIter = 1; binIter <= nSlicesx; binIter++){
    recalibrationArr1[binIter-1] = 1.0 + mean_te_by_ge_ge_EtaCut_CircularCut_HCALIN->GetBinContent(binIter);    
  ...
  Double_t weight_HCALOUT = 1.0 + te_by_ge_ge_EtaCut_CircularCut_HCALOUT->GetMean(2);
  ...
  for(int binIter = 1; binIter <= nSlicesx; binIter++){
    recalibrationArr2[binIter-1] = 1.0 + mean_te_by_ge_ge_EtaCut_CircularCut_HCALOUT->GetBinContent(binIter);
  ...
  Double_t weight_CEMC = 1.0 + te_by_ge_ge_EtaCut_CircularCut_CEMC->GetMean(2);
  ...
  for(int binIter = 1; binIter <= nSlicesx; binIter++){
    recalibrationArr3[binIter-1] = 1.0 + mean_te_by_ge_ge_EtaCut_CircularCut_CEMC->GetBinContent(binIter);
  ...
  for(int i=0; i<T1->GetEntries(); i++){
	...
	if (twr3){ 
      ...
      if(te_aggregate_CircularCut > energyCutAggregate){
	mean_te_by_ge_ge_EtaCut_CircularCut->Fill(ge, (te_aggregate_CircularCut_normalised-ge)/ge);
      }

      if(debug == 1){
	cout<<"(ge, te_aggregate_CircularCut_normalised/ge): ("<<ge<<", "<<(te_aggregate_CircularCut_normalised-ge)/ge<<")\n";
      }   
    }    
  }
  ...
  for(int binIter = 1; binIter <= nSlicesx; binIter++){
    recalibrationArr[binIter-1] = 1.0 + mean_te_by_ge_ge_EtaCut_CircularCut->GetBinContent(binIter);
  ...
  te_by_ge_ge_EtaCut->GetYaxis()->SetTitle("(te_{agg}-ge)/ge");
  ...
  te_by_ge_ge_EtaCut_CircularCut->GetYaxis()->SetTitle("(te_{agg}-ge)/ge");
  ...
  mean_te_by_ge_ge_EtaCut_CircularCut->GetYaxis()->SetTitle("Mean of (te_{agg}-ge)/ge");
  ...
  mean_te_by_ge_ge_EtaCut_CircularCut_HCALIN->GetYaxis()->SetTitle("Mean of (te_{agg}-ge)/ge (HCALIN)");
  ...
  mean_te_by_ge_ge_EtaCut_CircularCut_HCALOUT->GetYaxis()->SetTitle("Mean of (te_{agg}-ge)/ge (HCALOUT)");
  ...
  mean_te_by_ge_ge_EtaCut_CircularCut_CEMC->GetYaxis()->SetTitle("Mean of (te_{agg}-ge)/ge (CEMC)");
