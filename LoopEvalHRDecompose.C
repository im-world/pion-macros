...
void LoopEvalHRDecompose(int print = 1, int debug = 0, Double_t energyCutAggregate = 0.0, Double_t energyCut = 0.0)
{
  ...
  TH2D *te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_HCALIN = new TH2D("te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_HCALIN","#frac{#Delta e_{agg}}{truth e} vs truth e",nSlicesx,0,30,nSlicesy,te_minus_ge_by_ge_ge_min,te_minus_ge_by_ge_ge_max); 
  TH2D *te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_HCALOUT = new TH2D("te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_HCALOUT","#frac{#Delta e_{agg}}{truth e} vs truth e",nSlicesx,0,30,nSlicesy,te_minus_ge_by_ge_ge_min,te_minus_ge_by_ge_ge_max); 
  TH2D *te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_CEMC = new TH2D("te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_CEMC","#frac{#Delta e_{agg}}{truth e} vs truth e",nSlicesx,0,30,nSlicesy,te_minus_ge_by_ge_ge_min,te_minus_ge_by_ge_ge_max);
  ...
  TH2D *te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_CEMC_HCALIN = new TH2D("te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_CEMC_HCALIN","#frac{#Delta e_{agg}}{truth e} vs truth e",nSlicesx,0,30,nSlicesy,te_minus_ge_by_ge_ge_min,te_minus_ge_by_ge_ge_max); 
  TH2D *te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_HCALIN_HCALOUT = new TH2D("te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_HCALOUT_HCALIN","#frac{#Delta e_{agg}}{truth e} vs truth e",nSlicesx,0,30,nSlicesy,te_minus_ge_by_ge_ge_min,te_minus_ge_by_ge_ge_max); 
  TH2D *te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_CEMC_HCALOUT = new TH2D("te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_CEMC_HCALOUT","#frac{#Delta e_{agg}}{truth e} vs truth e",nSlicesx,0,30,nSlicesy,te_minus_ge_by_ge_ge_min,te_minus_ge_by_ge_ge_max);
  ...
  for(int i=0; i<T1->GetEntries(); i++){
    ...
    Double_t te_aggregate_CircularCut = 0;
    Double_t te_aggregate_CircularCut_normalised = 0;  
    Double_t te_aggregate_CircularCut_normalised_HCALIN = 0;
    Double_t te_aggregate_CircularCut_normalised_HCALOUT = 0;  
    Double_t te_aggregate_CircularCut_normalised_CEMC = 0;
	...
	if (twr1){ 
	  ...
	  Double_t te = twr1->get_te();
	    ...
	    if (pow(dphi/y_radius_HCALIN,2)+pow(dtheta/x_radius_HCALIN,2)<=1){
	      te_aggregate_CircularCut += te;
	      te_aggregate_CircularCut_normalised += te*weight_HCALIN/recalibrationArr1[recalibration_factor];
	      te_aggregate_CircularCut_normalised_HCALIN += te*weight_HCALIN/recalibrationArr1[recalibration_factor];
	    }
	  }
   	}
      }
	...
	if (twr2){ 
	  ...
	  Double_t te = twr2->get_te();
	    ...
	    if (pow(dphi/y_radius_HCALOUT,2)+pow(dtheta/x_radius_HCALOUT,2)<=1){
	      te_aggregate_CircularCut += te;
	      te_aggregate_CircularCut_normalised += te*weight_HCALOUT/recalibrationArr2[recalibration_factor];
	      te_aggregate_CircularCut_normalised_HCALOUT += te*weight_HCALOUT/recalibrationArr2[recalibration_factor];
	    }
	  }
   	}
      }
	...
	if (twr3){ 
	  ...
	  Double_t te = twr3->get_te();
	    ...
	    if (pow(dphi/y_radius_CEMC,2)+pow(dtheta/x_radius_CEMC,2)<=1){
	      te_aggregate_CircularCut += te;
	      te_aggregate_CircularCut_normalised += te*weight_CEMC/recalibrationArr3[recalibration_factor];
	      te_aggregate_CircularCut_normalised_CEMC += te*weight_CEMC/recalibrationArr3[recalibration_factor];
	    }
	  }
   	}
      }
	...
	te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_HCALIN->Fill(ge, ((te_aggregate_CircularCut_normalised_HCALIN/recalibrationArr[recalibration_factor])-ge)/ge);
	te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_HCALOUT->Fill(ge, ((te_aggregate_CircularCut_normalised_HCALOUT/recalibrationArr[recalibration_factor])-ge)/ge);
	te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_CEMC->Fill(ge, ((te_aggregate_CircularCut_normalised_CEMC/recalibrationArr[recalibration_factor])-ge)/ge);
	te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_CEMC_HCALOUT->Fill(ge, (((te_aggregate_CircularCut_normalised-te_aggregate_CircularCut_normalised_HCALIN)/recalibrationArr[recalibration_factor])-ge)/ge);
	te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_HCALIN_HCALOUT->Fill(ge, (((te_aggregate_CircularCut_normalised-te_aggregate_CircularCut_normalised_CEMC)/recalibrationArr[recalibration_factor])-ge)/ge);
	te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_CEMC_HCALIN->Fill(ge, (((te_aggregate_CircularCut_normalised-te_aggregate_CircularCut_normalised_HCALOUT)/recalibrationArr[recalibration_factor])-ge)/ge);
      }
  ...
  TH1D* slices_HCALIN[nSlicesx];
  TH1D* slices_HCALOUT[nSlicesx];
  TH1D* slices_CEMC[nSlicesx];
  TH1D* slices_CEMC_HCALIN[nSlicesx];
  TH1D* slices_HCALIN_HCALOUT[nSlicesx];
  TH1D* slices_CEMC_HCALOUT[nSlicesx];
  ...
  for(int sno = 0; sno < nSlicesx; sno++){
    ...
    TString sname_HCALIN = "HCALIN slice " + arr[sno];
    TString sname_HCALOUT = "HCALOUT slice " + arr[sno];
    TString sname_CEMC = "CEMC slice " + arr[sno];
    TString sname_CEMC_HCALIN = "CEMC HCALIN slice " + arr[sno];
    TString sname_HCALIN_HCALOUT = "HCALIN HCALOUT slice " + arr[sno];
    TString sname_CEMC_HCALOUT = "CEMC HCALOUT slice " + arr[sno];
    slices[sno] = te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp->ProjectionY(sname, plusOne, plusOne);
    slices_HCALIN[sno] = te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_HCALIN->ProjectionY(sname_HCALIN, plusOne, plusOne);
    slices_HCALOUT[sno] = te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_HCALOUT->ProjectionY(sname_HCALOUT, plusOne, plusOne);
    slices_CEMC[sno] = te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_CEMC->ProjectionY(sname_CEMC, plusOne, plusOne);
    slices_CEMC_HCALIN[sno] = te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_CEMC_HCALIN->ProjectionY(sname_CEMC_HCALIN, plusOne, plusOne);
    slices_HCALIN_HCALOUT[sno] = te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_HCALIN_HCALOUT->ProjectionY(sname_HCALIN_HCALOUT, plusOne, plusOne);
    slices_CEMC_HCALOUT[sno] = te_minus_ge_by_ge_ge_EtaCut_CircularCut_Recalibrated_temp_CEMC_HCALOUT->ProjectionY(sname_CEMC_HCALOUT, plusOne, plusOne);
  }
  ...
  for(int sno = 0; sno < nSlicesx; sno++){
    ...
    slices_HCALIN[sno]->GetXaxis()->SetTitle("#Delta e^{agg}/ ge");
    slices_HCALIN[sno]->GetXaxis()->SetLabelSize(0.05);  
    slices_HCALIN[sno]->GetXaxis()->SetTitleSize(0.05);
    slices_HCALIN[sno]->GetYaxis()->SetTitle("Counts");
    slices_HCALIN[sno]->GetYaxis()->SetLabelSize(0.05);  
    slices_HCALIN[sno]->GetYaxis()->SetTitleSize(0.05);

    slices_HCALOUT[sno]->GetXaxis()->SetTitle("#Delta e^{agg}/ ge");
    slices_HCALOUT[sno]->GetXaxis()->SetLabelSize(0.05);  
    slices_HCALOUT[sno]->GetXaxis()->SetTitleSize(0.05);
    slices_HCALOUT[sno]->GetYaxis()->SetTitle("Counts");
    slices_HCALOUT[sno]->GetYaxis()->SetLabelSize(0.05);  
    slices_HCALOUT[sno]->GetYaxis()->SetTitleSize(0.05);

    slices_CEMC[sno]->GetXaxis()->SetTitle("#Delta e^{agg}/ ge");
    slices_CEMC[sno]->GetXaxis()->SetLabelSize(0.05);  
    slices_CEMC[sno]->GetXaxis()->SetTitleSize(0.05);
    slices_CEMC[sno]->GetYaxis()->SetTitle("Counts");
    slices_CEMC[sno]->GetYaxis()->SetLabelSize(0.05);  
    slices_CEMC[sno]->GetYaxis()->SetTitleSize(0.05);

    slices_CEMC_HCALIN[sno]->GetXaxis()->SetTitle("#Delta e^{agg}/ ge");
    slices_CEMC_HCALIN[sno]->GetXaxis()->SetLabelSize(0.05);  
    slices_CEMC_HCALIN[sno]->GetXaxis()->SetTitleSize(0.05);
    slices_CEMC_HCALIN[sno]->GetYaxis()->SetTitle("Counts");
    slices_CEMC_HCALIN[sno]->GetYaxis()->SetLabelSize(0.05);  
    slices_CEMC_HCALIN[sno]->GetYaxis()->SetTitleSize(0.05);

    slices_HCALIN_HCALOUT[sno]->GetXaxis()->SetTitle("#Delta e^{agg}/ ge");
    slices_HCALIN_HCALOUT[sno]->GetXaxis()->SetLabelSize(0.05);  
    slices_HCALIN_HCALOUT[sno]->GetXaxis()->SetTitleSize(0.05);
    slices_HCALIN_HCALOUT[sno]->GetYaxis()->SetTitle("Counts");
    slices_HCALIN_HCALOUT[sno]->GetYaxis()->SetLabelSize(0.05);  
    slices_HCALIN_HCALOUT[sno]->GetYaxis()->SetTitleSize(0.05);

    slices_CEMC_HCALOUT[sno]->GetXaxis()->SetTitle("#Delta e^{agg}/ ge");
    slices_CEMC_HCALOUT[sno]->GetXaxis()->SetLabelSize(0.05);  
    slices_CEMC_HCALOUT[sno]->GetXaxis()->SetTitleSize(0.05);
    slices_CEMC_HCALOUT[sno]->GetYaxis()->SetTitle("Counts");
    slices_CEMC_HCALOUT[sno]->GetYaxis()->SetLabelSize(0.05);  
    slices_CEMC_HCALOUT[sno]->GetYaxis()->SetTitleSize(0.05);
  }
  ...
  for(int sno = 0; sno < nSlicesx; sno++){
    ...
    f->GetList()->Add(slices_HCALIN[sno]);
    f->GetList()->Add(slices_HCALOUT[sno]);
    f->GetList()->Add(slices_CEMC[sno]);
    f->GetList()->Add(slices_CEMC_HCALIN[sno]);
    f->GetList()->Add(slices_HCALIN_HCALOUT[sno]);
    f->GetList()->Add(slices_CEMC_HCALOUT[sno]);
  }
  ...
  */
  ...
  if(print==1){
    ...
    for(int sno = 0; sno < nSlicesx; sno++){
     ...
     for(int sno = 0; sno < nSlicesx; sno++){
      TString plusOne = (TString)(sno + 1);
      TString nameF_HCALIN = "HCALIN_sigmaE_slice" + arr[sno] + "_EtaCut_CircularCut.png";
      slices_HCALIN[sno] -> Fit("fit", "M+");
      slices_HCALIN[sno] -> Draw("hist same");
      c->Print(nameF_HCALIN);
    }

    for(int sno = 0; sno < nSlicesx; sno++){
      TString plusOne = (TString)(sno + 1);
      TString nameF_HCALOUT = "HCALOUT_sigmaE_slice" + arr[sno] + "_EtaCut_CircularCut.png";
      slices_HCALOUT[sno] -> Fit("fit", "M+");
      slices_HCALOUT[sno] -> Draw("hist same");
      c->Print(nameF_HCALOUT);
    }

    for(int sno = 0; sno < nSlicesx; sno++){
      TString plusOne = (TString)(sno + 1);
      TString nameF_CEMC = "CEMC_sigmaE_slice" + arr[sno] + "_EtaCut_CircularCut.png";
      slices_CEMC[sno] -> Fit("fit", "M+");
      slices_CEMC[sno] -> Draw("hist same");
      c->Print(nameF_CEMC);
    }

    for(int sno = 0; sno < nSlicesx; sno++){
      TString plusOne = (TString)(sno + 1);
      TString nameF_CEMC_HCALIN = "CEMC_HCALIN_sigmaE_slice" + arr[sno] + "_EtaCut_CircularCut.png";
      slices_CEMC_HCALIN[sno] -> Fit("fit", "M+");
      slices_CEMC_HCALIN[sno] -> Draw("hist same");
      c->Print(nameF_CEMC_HCALIN);
    }

    for(int sno = 0; sno < nSlicesx; sno++){
      TString plusOne = (TString)(sno + 1);
      TString nameF_CEMC_HCALOUT = "CEMC_HCALOUT_sigmaE_slice" + arr[sno] + "_EtaCut_CircularCut.png";
      slices_CEMC_HCALOUT[sno] -> Fit("fit", "M+");
      slices_CEMC_HCALOUT[sno] -> Draw("hist same");
      c->Print(nameF_CEMC_HCALOUT);
    }

    for(int sno = 0; sno < nSlicesx; sno++){
      TString plusOne = (TString)(sno + 1);
      TString nameF_HCALIN_HCALOUT = "HCALIN_HCALOUT_sigmaE_slice" + arr[sno] + "_EtaCut_CircularCut.png";
      slices_HCALIN_HCALOUT[sno] -> Fit("fit", "M+");
      slices_HCALIN_HCALOUT[sno] -> Draw("hist same");
      c->Print(nameF_HCALIN_HCALOUT);
    }
